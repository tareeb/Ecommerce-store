...
const URL = `${process.env.NEXT_PUBLIC_Recommendation_API_URL}/recommend_prod_cust`;
const product_URL =`${process.env.NEXT_PUBLIC_API_URL}/products/getlist`;

const getCustRecommendations = async (id : string) : Promise<Product[]> => {    
    try{    
...
export default getCustRecommendations;
